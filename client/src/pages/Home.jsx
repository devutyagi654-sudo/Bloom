...
const Home = () => {
  ...
  const handleNewsletterSubmit = async (e) => {
    ...
    try {
      ...
      setNewsletterStatus({ type: 'success', msg: 'Welcome to the BLC Atelier Club. Please check your inbox shortly.' });
      setNewsletterEmail('');
    } catch (err) {
      setNewsletterStatus({
        type: 'error',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="max-w-xl space-y-6">
            ...
            <p className="text-neutral-400 font-light text-sm sm:text-base leading-relaxed">
              Every diamond at BLC is individually inspected and sourced conflict-free. Certified GIA certificates accompany every ring, ensuring purity, longevity, and high investment metrics for our global collectors.
            </p>
